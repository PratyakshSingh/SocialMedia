...
const UserProfile = () => {
    ...
    },[error,message,dispatch,followError,userError,alert])
            ...
            <div className="accountleft">
            {
                posts && posts.length > 0 ? posts.map(post => (
                    <Post key={post._id}
                        ...
                        isUserProfile={true}
                    />
                )): <Typography variant="h6">User doesnot have any post</Typography>
                    ...
                    <div className="DialogBox">
...

                        {
                            user && user.following.length > 0 ? (
                                ...
                                <Typography style={{ margin: "2vmax"}}>You donot follow anyone</Typography>
                            )
                        }
                    </div>
                </Dialog>
